...
const getCustomResponse = (text, prefix) => {
  ...
  if (lowerText.includes('owner') || lowerText.includes('developer') || lowerText.includes('creator') || 
    ...
    return {
      text: `*👨‍💻 MEET THE DEVELOPERS*\n\n🇰🇪 *Primary Developer:* OBEDTECH Tech\n• Location: Kenya\n• Specialization: AI Integration & Bot Development\n• Role: Lead Developer & Project Owner\n\n🤖 *Technical Partner:* OBED TECH\n• Specialization: Backend Systems & API Management\n• Role: Technical Support & Infrastructure\n\n*About Our Team:*\nHunter AI is the result of a collaborative effort between CaseyRhodes Tech and OBED TECH. Together, we bring you cutting-edge AI technology with reliable bot functionality, ensuring you get the best AI experience possible.\n\n*Proudly Made in Kenya* 🇰🇪`,
      footer: "HunterXmd Tech x OBED TECH - Kenyan Innovation",
      buttons: [
        { buttonId: `${prefix}menu`, buttonText: { displayText: "MAIN MENU" }, type: 1 },
        { buttonId: `${prefix}aimenu`, buttonText: { displayText: "AI MENU" }, type: 1 },
  ...
  if (lowerText.includes('what is your name') || lowerText.includes('what\'s your name') || 
    ...
    return {
      text: `*🏷️ MY NAME*\n\n👋 Hello! My name is *HUNTER AI*\n\n*About My Name:*\n• Full Name: Hunter AI\n• Short Name:hunter\n• You can call me: Hunter, Hunter AI, or just AI\n\n*Name Origin:*\nI'm named after my primary developer *Hunter-Xmd Tech*, combining the personal touch of my creator with the intelligence of artificial intelligence technology.\n\n*What Casey Stands For:*\n🔹 *C* - Creative Problem Solving\n🔹 *A* - Advanced AI Technology\n🔹 *S* - Smart Assistance\n🔹 *E* - Efficient Responses\n🔹 *Y* - Your Reliable Companion\n\n*Made in Kenya* 🇰🇪 *by Obed Tech*`,
      footer: "Hunter AI - That's Me! 😊",
      buttons: [
        { buttonId: `${prefix}aimenu`, buttonText: { displayText: "AI MENU" }, type: 1 },
